module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            build: {
                files: ['Gruntfile.js', 'index.html', 'js/app/src/**/*.js', 'js/app/src/**/**/*.js', 'js/app/src/**/**/**/*.js', 'css/src/*.css', 'html/src/**/**/**/*.html', 'html/src/**/**/html', 'html/src/**/*.html'],
        ...
        concat: {
            ...
            dist: {
                src: ['js/lib/bower_components/angular/angular.min.js',
                    ...
                    'js/lib/sort/Sortable.min.js',
                    'js/lib/sort/ng-sortable.js',
                    'js/app/src/**/*.js',
                    'js/app/src/**/**/*.js',
                    'js/app/src/**/**/**/*.js',
